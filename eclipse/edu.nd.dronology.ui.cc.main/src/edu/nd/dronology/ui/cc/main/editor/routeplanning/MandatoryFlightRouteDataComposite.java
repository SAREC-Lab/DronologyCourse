...
public class MandatoryFlightRouteDataComposite extends AbstractMandatoryItemComposite<IFlightRoute> {
	...
	public MandatoryFlightRouteDataComposite(Composite parent, AbstractUAVEditorPage page) {
		super(parent, page);
	}
	...
	protected void createFields() {
		...
		cmbType.add(ImageProvider.IMG_DRONE_FLYING, "South-Bend Area");
		cmbType.add(ImageProvider.IMG_DRONE_FLYING, "River");
