...
public class MandatorySpecificationDataComposite extends AbstractMandatoryItemComposite<IDroneSpecification> {
	...
	public MandatorySpecificationDataComposite(Composite parent, UAVSpecificationPage page) {
		super(parent, page);
	}
	...
	protected void setType() {
		page.getItem().setType(cmbType.getItem(cmbType.getSelectionIndex()));
System.out.println(page.getItem().getType());
	}
	...
	public void doSetValuesToFields() {
		...
		String typ = page.getItem().getType();
