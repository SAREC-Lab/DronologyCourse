...
public class SkinnedExceptionDetailsDialog extends Dialog {
	 ...
	 * @param parentShell
	 */
	protected SkinnedExceptionDetailsDialog(Shell parentShell, String title, String message, String error) {
		super(parentShell);
		this.title = title;
	...
	protected Control createDialogArea(Composite parent) {
		...
		parent.setData(StyleProvider.CSS_TAG, "ProgressDialog");
		return container;
	}
