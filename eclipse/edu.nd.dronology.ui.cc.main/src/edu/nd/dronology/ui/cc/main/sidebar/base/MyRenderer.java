...
public class MyRenderer extends AbstractRenderer {
	 ...
	 * 
	 */
	private static final long serialVersionUID = 6419926245125148868L;

	private Color[] initialColors; // to dispose created colors

	private int textMargin = 2;
	private int margin = 4;
	private MyShelf parent;
	...
	public Point computeSize(GC gc, int wHint, int hHint, Object value) {
		MyShelfItem item = (MyShelfItem) value;
	...
	public void paint(GC gc, Object value) {
		...
		String str = getShortString(gc, item.getText2(), textWidth);
		gc.drawString(str, getBounds().width-45, getBounds().y + y2, true);
