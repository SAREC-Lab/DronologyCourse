 ...
 * </p>
 */
public class MyShelfItem extends Item {
     ...
     * </ul>
     */
	public MyShelfItem(MyShelf parent, int style,int index) {
     ...
     * </ul>
     */
	public MyShelfItem(MyShelf parent, int style) {
		super(parent,style);
		construct(parent,-1);
	}

	private void construct(MyShelf parent,int index){
		this.parent = parent;
