...
public class FlightPlanXStreamPersistor implements IPersistenceManager<IFlightPath> {

	private static final XStream xstream = new XStream(new XppDriver());
	private static ILogger LOGGER = LoggerProvider.getLogger(FlightPlanXStreamPersistor.class);

	static final boolean useCompression = false;

	@Override
	public IFlightPath open(InputStream fin) throws PersistenceException {
	...
	private IFlightPath loadUncompressedStream(InputStream fin) throws PersistenceException {
		try {
	...
	private IFlightPath loadedCompressedStream(InputStream fin) throws PersistenceException {
	...
	@Override
	public boolean save(IFlightPath o, OutputStream fout) throws PersistenceException {
		DronologyPersistenceUtil.preprocessStream(xstream);
	...
	private boolean saveUncompressedStream(IFlightPath o, OutputStream fout) throws PersistenceException {
	...
	private boolean saveCompressedStream(IFlightPath o, OutputStream fout) throws PersistenceException {
		try {
