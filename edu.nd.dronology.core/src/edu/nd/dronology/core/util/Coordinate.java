...
//	/**
//	 * @param lat
//	 *          Latitude in signed degrees format (DDD.dddd) Example: 41.707762
//	 * @param lon
//	 *          Longitude in signed degrees format (DDD.ddd) Example: -86.226880
//	 * @param alt
//	 *          Altitude in meters. Default is 0. Altitude is always relative to launch altitude.
//	 */
...
//		return "Latitude: " + Long.toString(latitude) + ", Longitude: " + Long.toString(longitude) + " Altitude: "
...
//
//		/*
//		 * Check if o is an instance of Coordinate or not "null instanceof [type]" also returns false
//		 */
...
//		if (coord.altitude == this.altitude && coord.latitude == this.latitude && coord.longitude == this.longitude)
//			return true;
//		else
//			return false;
//	}
