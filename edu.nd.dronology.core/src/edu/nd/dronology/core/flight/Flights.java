...
//
///**
// * Tracks the status of all flights as they move through the cycle of pending,
// * awaiting take off, current, to completed.
// * 
...
//
//	private ManagedHashTableList<ManagedDrone, IFlightPlan> assignedFlightsToDrone = new ManagedHashTableList<>();
...
//
//	/**
//	 * Assigns the next available flight plan to a pending flight at the top of
//	 * the pending list.
//	 * 
...
//
//		PlanPoolManager.getInstance().addNewPlan(flightPlan);
//	}
//
//	/**
